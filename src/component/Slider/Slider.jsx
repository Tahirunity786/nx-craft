...
const slides = [
  { id: 1, title: 'Choose a Service', property: 'Property 1' },
  { id: 2, title: 'Select Technologies', property: 'Property 2' },
  { id: 3, title: 'Select Property 3', property: 'Property 3' },
];

export default function Slider() {
  const [currentSlide, setCurrentSlide] = useState(0);
  const [activeIndex, setActiveIndex] = useState(-1); // State to track the active button
        ...
        <div className="row">
          ...
          <div className="col-8">
            <div className="row">
              {
                Hire.map((item, index) => (
                  <div className={`col-lg-4 bg-hire-nx p-3 pt-4 pb-4 ${activeIndex === index ? "active-hire" : ""}`} key={item.id} onClick={() => {handleActive(index); handleNext()}}>
