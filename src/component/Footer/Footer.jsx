        ...
        <div className="row">
          <div className="col-lg-7">
            ...
            <ul className="mb-5 d-flex justify-content-start align-items-center flex-wrap ul-footer ps-1 pe-5">
              ...
              <li className='mb-2'>
                <Link href="/services" className="nav-link text-light me-4">
                  Services
                </Link>
              </li>
              <li className='mb-2'>
                <Link href="/portfolio" className="nav-link text-light me-4">
                  Portfolio
                </Link>
              </li>
              <li className='mb-2'>
                <Link href="/hire" className="nav-link text-light me-4">
                  Hire us
                </Link>
              </li>
              <li className='mb-2'>
